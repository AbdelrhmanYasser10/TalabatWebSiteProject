...
function DelEmployeeData(){
    ...
    $sql="SELECT name FROM employees WHERE ID = '$sid'";
    $result=mysqli_query($mysqli,$sql);
    $row=mysqli_fetch_array($result);
  
    include('conn.php');
    $sql2 = "DELETE FROM employees WHERE id = '$sid'";
    $conn->exec($sql2);
  echo'
  <h6 class="card-subtitle mb-2 text-muted">Employee Name :'.$row[0].'</h6>
...
<body id="page-top">
  ...
  <div class="card-body">
    <h5 class="card-title">Delete Employee info</h5>
    <?php
    DelEmployeeData();
    ?>
