...
function drawOptions(){
    ...
    foreach($row as $r){
        echo'<option>'.$r['Rest_name'].'</option>';
    }
}
    ...
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            <h5 class="card-title text-center">Add Meal</h5>
            <form id="AddMeal" method="post">

         

              <div class="form-label-group">
                <input type="text" id="MealName" name="MealName" class="form-control" placeholder="Meal Name" required>
                <label for="MealName">Meal Name</label>
              </div>


                                <div class="form-group">
                        <select class="form-control" name="SelectResturant" id="SelectResturant" required>
                        <label for="SelectResturant">Select Resturant</label>
              ...
              <div class="form-label-group">
                <input type="text" id="details" name="details" class="form-control" placeholder="Meal Details" required>
